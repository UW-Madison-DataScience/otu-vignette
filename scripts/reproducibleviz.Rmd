...
The `tidyverse` R package loads several packages, including `ggplot2`, which we will use to create our reproducible visualization; `tidyverse` will also load in `dplyr` which we will use to manipulate the data and ultimately add text to our visualization.
